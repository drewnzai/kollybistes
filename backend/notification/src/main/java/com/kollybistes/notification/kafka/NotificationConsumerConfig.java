...
public class NotificationConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, NotificationEmail> containerFactory(){
        ConcurrentKafkaListenerContainerFactory<String, NotificationEmail> factory =
